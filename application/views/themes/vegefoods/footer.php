...
<footer class="ftco-footer ftco-section ftco-animated">
  <div class="container">
    <div class="row">
      <div class="mouse">
        ...
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="block-23 mb-3">
            <ul>
              ...
              <li><a href="https://wa.me/6281283458037?text=Saya%20ingin%20Bertanya"><span class="icon icon-phone"></span><span class="text"><?php echo get_settings('store_phone_number'); ?></span></a></li>
              <li><a href="mailto:wibowosatrio2002@gmail.com"><span class="icon icon-envelope"></span>&nbsp;&nbsp;<span class="text"> <?php echo get_settings('store_email'); ?></span></a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <p>
          ...
          </script> All rights reserved | Made with <i class="icon-heart text-danger" aria-hidden="true"></i> Ropel.
          <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        </p>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  if (pol1) {
    Swal.fire({
      position: 'top-center',
      html: '<div class="alert alert-danger" role="alert">' + pol1 + '</div > ',
      showConfirmButton: false,
      background: '#FF4500',
      showClass: {
        popup: 'ftco-animated fadeInDown'
      },
      hideClass: {
        popup: 'ftco-animated fadeOutUp'
      },
      timer: 1000,
    })
  }
