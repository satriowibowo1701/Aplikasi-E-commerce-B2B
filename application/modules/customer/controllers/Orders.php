    ...
    public function order_api()
    {
        ...
        switch ($action) {
            ...
            case 'delete_order':
                ...
                if ((($data->payment_method == 1 or $data->payment_method == 3)  && ($data->order_status == 5 || $data->order_status == 4)) || ($data->payment_method == 2 && ($data->order_status == 4 || $data->order_status == 3))) {
                    $this->order->delete_order($id, $data->order_number);
