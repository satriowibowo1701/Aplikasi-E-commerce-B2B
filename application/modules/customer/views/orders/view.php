    ...
    <section class="content">
        <div class="row">
            <div class="col-md-8">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-hover table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td><b><?php if ($data->payment_method == 1)
                                            echo 'Transfer Manual';
                                        elseif ($data->payment_method == 2) {
                                            echo 'Bayar Di Tempat';
                                        } else {
                                            echo $delivery_data->bank;
                                        }
                                        ?></b></td>
                            </tr>
                            <tr>
                ...
                <?php if ($this->session->flashdata('order_flash')) { ?>
                    <div class="sukses" data-sukses="<?= $this->session->userdata('order_flash'); ?>"></div>
                <?php $this->session->unset_userdata('order_flash');
                } ?>
                <div class="card card-primary">
                    <div class="card-header">
                            ...
                            <table class="table table-hover table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><b>
                                            ...
                                            <?php elseif ($data->payment_status == 0) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><b>
                                            ...
                                            <?php   } elseif ($data->payment_method == 3) { ?>
                                                <b><?php echo $transfer_from->bank; ?><br>No.Pembayaran:(<?php echo $transfer_from->number; ?>)</b>
                                            <?php } ?>
                                        </b></td>
                                </tr>
                                <?php if ($data->payment_method == 1) { ?>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="text-center actionRow">
                            <!-- diubah -->
                            <?php if ($data->payment_method == 1 or $data->payment_method == 3) : ?>
...
<!-- Diubah  -->
<?php if ((($data->payment_method == 1 or $data->payment_method == 3) && $data->order_status == 1) || ($data->payment_method == 2 && $data->order_status == 1) ||  ($data->payment_method == 3 && $data->order_status == 1)) : ?>
    ...
    <script>
        $('.cancel-btn').click(function(e) {
            ...
            $.ajax({
                ...
                data: {
                    id: <?php echo $data->id; ?>,
                    name: '<?php echo $delivery_data->customer->name ?>',
                },
                context: this,
                success: function(res) {
                    if (res.code == 200) {
                        if (res.success) {
                            ...
                            setTimeout(() => {
                                $(this).html('<i class="fa fa-spin fa-spinner"></i> Mengalihkan...');
                            }, 3000);
                            setTimeout(() => {
                                window.location = '<?php echo site_url('customer/orders/view/' . $data->id); ?>';
                            }, 1000);
                        } else if (res.error) {
...
<?php elseif ((($data->payment_method == 1 or $data->payment_method == 3) && ($data->order_status == 5 || $data->order_status == 4)) || ($data->payment_method == 2 && ($data->order_status == 4 || $data->order_status == 3))) : ?>
