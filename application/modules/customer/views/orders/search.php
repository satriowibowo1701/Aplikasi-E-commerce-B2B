...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Terdapat Sebanyak <?= $count ?> Pencarian Data <?= $this->input->get('query') ?></h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <table class="table table-striped m-0">
                            ...
                            <?php foreach ($orders as $order) : ?>
                                <tr>
                                    ...
                                    <td><?php echo ($order->payment_method == 1) ? 'Transfer Bank Manual' : (($order->payment_method == 3) ? 'Pembayaran Otomatis' : 'Bayar ditempat'); ?></td>
