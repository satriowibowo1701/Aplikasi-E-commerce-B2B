        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <?php $newname = json_decode($tol->delivery_data); ?>
                    <input type="hidden" value="<?= $newname->customer->name ?>" id="cusname">
                </div>
                <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card card-primary">
                    ...
                    <?php
                    $dat = json_decode($tol->delivery_data, true);
                    $paym = $orders[0]->payment_method;

                    if ($paym == 3) {
                        echo form_open_multipart('#');
                    } else {
                        echo form_open_multipart('customer/payments/do_confirm');
                    } ?>
                    <div class="card-body">
                        ...
                        <?php if ($paym == 3) { ?>
                            <div class="form-group">
                                ...
                                <input type="text" name="ordernumber" value="#<?= $tol->order_number; ?> - (Rp.<?= format_rupiah($tol->total_price) ?>)" class="form-control" id="banknam" readonly>
                            </div>
                        <?php } else { ?>
                            <div class="form-group">
                                <label class="form-control-label" for="orders">Order:</label>
                                <?php if (count($orders) > 0 && isset($_GET['order'])) : ?>
                                    <select name="order_id" class="form-control" id="orders">
                                        <?php

                                        foreach ($orders as $order) : ?>
                                            <?php if ($order->id == $_GET['order']) { ?>
                                                ...
                                                <input type="hidden" name="noorders" value="<?= $order->order_number; ?>">
                                            <?php } ?>
                                        <?php endforeach;
                                        ?>
                                    </select>
                        ...
                        if ($paym == 3) { ?>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?= strtoupper($dat['bank']) ?>" class="form-control" id="banknam" readonly>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label class="form-control-label">No Pembayaran</label>
                                        <input type="text" value="<?= $dat['va_number'] ?>" class="form-control" id="nopem" readonly>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="bank_number" class="form-control-label">Waktu Transaksi</label>
                                        <input type="text" name="waktu" value="<?= $dat['waktu_transaksi'] ?>" class="form-control" id="waktu" readonly>
                                    </div>
                                </div>
                            </div>
                            <!-- Ubah -->
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <span class="btn btn-danger waktu">Waktu Pembayaran : STOP!!!</span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php elseif ($payment->payment_status == 0) : ?>
                                                <span class="badge badge-info text-white">Menunggu Pembayaran</span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
