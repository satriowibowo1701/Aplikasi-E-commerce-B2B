...
<div id="container">
    ...
    <script>
        ...
        $('.shawCalRanges').daterangepicker({
            ...
            startDate: '<?= $datatable[0]->startdate ?>',
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            datable = $('#table-id').DataTable({
                ...
                "ajax": {
                    "url": "<?= base_url('admin/change_table') ?>",
                    "type": "POST",
                    "data": function(data) {
                ...
                buttons: [{
                    ...
                    {
                        extend: 'collection',
                        text: '<i class="fas fa-save"></i> Export As',
                        ...
                        buttons: [{
                                ...
                                className: 'green',
                                title: function() {
                                    return 'Data Penjualan Tanggal ' + $('#rangetgl').val()
                                },
                                filename: function() {
                                    return 'Data Penjualan Tanggal ' + $('#rangetgl').val()
                                },
...
`,
        ...
        function reload_table() {
            datable.ajax.reload(null, false); //reload datatable ajax 
        }
    </script>