...
<div class="container-fluid mt--6">
  <div class="row">
    <?php if ($payment->picture_name == null) {
  ...
  <?php if ($payment->picture_name != null) { ?>
    <div class="col-md-4">
      <div class="card card-primary">
        ...
        <div class="card-body p-0">
          <img alt="Pembayaran Order #<?php echo $payment->order_number; ?>" width="430" height="600" src="<?php echo base_url('assets/uploads/payments/' . $payment->picture_name); ?>">
        </div>
