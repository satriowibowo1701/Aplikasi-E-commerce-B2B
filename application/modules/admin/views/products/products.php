                  ...
                  <div class="card card-primary">
                    ...
                    <div class="card-body">
                      <div class="text-center">
                        <img alt="<?php echo $product->name; ?>" src="<?php echo base_url('assets/uploads/products/' . $product->picture_name); ?>" style="height:200px; width:600px;" class="img img-fluid rounded mb-3">
