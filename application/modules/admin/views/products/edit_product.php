            ...
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="pills-current" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="text-center">
                  <img alt="<?php echo $product->name; ?>" src="<?php echo base_url('assets/uploads/products/' . $product->picture_name); ?>" class="img img-fluid rounded" style="height:200px; width:600px;">
                </div>
              </div>
