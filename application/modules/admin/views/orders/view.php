      ...
      <div class="card-wrapper">
        <div class="card">
          ...
          <div class="card-body p-0">
            <table class="table align-items-center table-flush table-striped">
              ...
              <tr>
                ...
                <td><b><?php echo ($data->payment_method == 1) ? 'Transfer bank' : (($data->payment_method == 3) ? 'Payment Gateway' : 'Bayar ditempat'); ?></b></td>
              </tr>
              <tr>
                <td>Status</td>
          ...
          <div class="card-footer">
            <?php
            if ($data->order_status != 5 && $data->order_status != 4) { ?>
              <form action="<?php echo site_url('admin/orders/status'); ?>" method="POST">
                <input type="hidden" name="order" value="<?php echo $data->id; ?>">
                <input type="hidden" name="noorder" value="<?= $data->order_number ?>">
                <div class="row">
                  <div class="col-md-10">
                    <div class="form-group">
                      <?php if ($data->payment_method == 1 || $data->payment_method == 3) : ?>
                ...
                <tr>
                  ...
                  <td>
                    <div style="white-space: initial;"><b>
                        ...
                        <?php } else { ?>
                          <b><?php echo $transfer_from->bank; ?> a.n <?php echo $transfer_from->name; ?><br>No.Pembayaran:(<?php echo $transfer_from->number; ?>)</b>
                        <?php  } ?>
                      </b></div>
                  </td>
                </tr>
