...
class Email1 extends CI_Controller
{
    ...
    public function email($subject, $ordern, $total, $link, $data, $trx = null, $payment = null, $user_id = null)
    {

        $newdata = json_decode($data);
        $datenew = ($trx == null) ? $newdata->waktu_transaksi : $trx;
        $msgexpdate = "";
        if ($payment == null) {
            $msgexpdate = '<p style="margin: 0;">Batas&nbsp; Waktu : ' . $datenew . '</p>';
        } else {
            $msgexpdate = "";
        }
                                                            ...
                                                            <table class="text_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                                <tr>
                                                                    <td class="pad">
                                                                        <div style="font-family: sans-serif">
                                                                            <div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #052d3d; line-height: 1.2;">
                                                                                <p style="margin: 0; text-align: center; font-size: 12px;"><span style="font-size:20px;">Detail Pembayaran</span></p>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td class="pad">
                                                                        <div style="color:#000000;direction:ltr;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;font-size:21px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:25.2px;">
                                                                            <p style="margin: 0; margin-bottom: 16px;">Halo, ' . $newdata->customer->name . '</p>
                                                                            <p style="margin: 0; margin-bottom: 16px;">Lakukan pembayaran sebelum batas waktu yang telah ditentukan.</p>
                                                                            <p style="margin: 0; margin-bottom: 16px;">Nomer Orderan : ' . $ordern . '</p>

                                                                            <p style="margin: 0; margin-bottom: 16px;">Total Belanja : Rp.' . format_rupiah($total) . '</p> 
                                                                            ' . $msgexpdate . '
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td class="pad" style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:50px;text-align:center;">
                                                                        <div class="alignment" align="center">
                                                                            <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:46px;width:262px;v-text-anchor:middle;" arcsize="33%" stroke="false" fillcolor="#fc7318"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, Verdana, sans-serif; font-size:18px"><![endif]--><a href="' . $link . '" target="_blank" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#fc7318;border-radius:15px;width:auto;border-top:1px solid #fc7318;font-weight:400;border-right:1px solid #fc7318;border-bottom:1px solid #fc7318;border-left:1px solid #fc7318;padding-top:5px;padding-bottom:5px;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:18px;display:inline-block;letter-spacing:normal;"><span dir="ltr" style="word-break: break-word;"><span style="line-height: 36px;" dir="ltr" data-mce-style><strong>Lanjutkan Pembayaran›&nbsp;</strong></span></span></span></a>
                                                                    ...
                                                                    <td class="pad" style="padding-bottom:30px;padding-left:10px;padding-right:10px;">
                                                                        <div style="font-family: sans-serif">
                                                                            <div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px; color: #787878; line-height: 1.5;">
                                                                                <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 27px;"><span style="font-size:18px;">Email: ' . get_settings('store_email') .
            '</span></p>
                                                                                <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 27px;"><span style="font-size:18px;">Telpon: ' . get_settings('store_phone_number') .
            '<br><strong> ' . get_settings('store_tagline') .
            '</strong></span></p>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td class="pad">
                                                                        <div style="font-family: sans-serif">
                                                                            <div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                                                                <p style="margin: 0; font-size: 14px; text-align: center;">Rm Murniasiah - Rumah Makan&nbsp; Lengkap.&nbsp;</p>
                                                                                <p style="margin: 0; font-size: 14px; text-align: center;">Perum Griya Alam Sentosa Blok L 19 No.-03 Cileungsi-Bogor</p>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
